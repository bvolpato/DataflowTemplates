  ...
  public void execute() throws MojoExecutionException {
    ...
    try {
      ...
      if (definition.isClassic()) {
        String templatePath =
            configuredMojo.stageClassicTemplate(definition, imageSpec, pluginManager);
        ...
        String templatePath =
            configuredMojo.stageFlexTemplate(definition, imageSpec, pluginManager);
      ...
      LOG.info(
          "Created template job with ID {}. Console: https://console.cloud.google.com/dataflow/jobs/{}/{}?project={}",
          job.getId(),
          job.getLocation(),
          job.getId(),
          job.getProjectId());
      ...
      LOG.info(
          "To cancel the project, use: gcloud dataflow jobs cancel {} --project {} --region {}",
          job.getId(),
          job.getProjectId(),
          job.getLocation());
      ...
      throw new MojoExecutionException("Invalid run argument (" + e.getErrorDetails() + ")", e);
    } catch (Exception e) {
