...
public interface DataplexJdbcIngestionOptions
    extends GcpOptions, PipelineOptions, DataplexUpdateMetadataOptions, CommonTemplateOptions {
  ...
  @TemplateParameter.Text(
      ...
      helpText =
          "Dataplex output asset ID to which the results are stored to. Should be in the format of projects/your-project/locations/<loc>/lakes/<lake-name>/zones/<zone-name>/assets/<asset-name>")
  @Validation.Required
  ...
  @TemplateParameter.Text(
      ...
      helpText =
          "The partition column on which the partition is based. The column type must be of timestamp/date format.")
