 ...
 * the License.
 */
package com.google.cloud.teleport.v2.elasticsearch;
...
/** Utilities to make working with ElasticsearchTestUtils easier. */
public final class ElasticsearchTestUtils {
   ...
   *     prefix
   */
  public static String createIndexName(String prefix) {
