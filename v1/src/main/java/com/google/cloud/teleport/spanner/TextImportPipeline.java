...
public class TextImportPipeline {
  ...
  public interface Options extends PipelineOptions {
    ...
    @TemplateParameter.GcsWriteFolder(
        ...
        optional = true,
        helpText =
            "Cloud Storage path where to write rows that cannot be imported.",
  ...
  public static void main(String[] args) {
    ...
    p.apply(new TextImportTransform(spannerConfig, options.getImportManifest(), options.getInvalidOutputPath()));
